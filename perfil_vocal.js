...
const PERFIS_VOCAIS = [
  ...
  {nome:'Celeste Mourão Braga',tipo:'ator',genero:'F',tessitura:'contralto',arquetipoVocal:'Voz contralto — timbre de romance, vulnerabilidade magnética',vozSintese:{vozId:'pt-BR-BrendaNeural',pitch:1.16,rate:0.96}},
  ...
  {nome:'Rafael Queiroga Salave\'a',tipo:'ator',genero:'M',tessitura:'grave',arquetipoVocal:'Voz grave — timbre de romance, o amor que machuca com gentileza',vozSintese:{vozId:'pt-BR-HumbertoNeural',pitch:1.1,rate:0.9}},
  ...
  {nome:'Kenji Matsunaga Rios',tipo:'ator',genero:'M',tessitura:'barítono',arquetipoVocal:'Voz barítono — timbre de experimental, hibridismo cultural como linguagem',vozSintese:{vozId:'pt-BR-JulioNeural',pitch:1.03,rate:1.1}},
  ...
  {nome:'Isadora Vellini',tipo:'cantor',genero:'F',tessitura:'soprano',arquetipoVocal:'Soprano lírico de primeiro escalão — voz que equilibra pureza italiana e calor brasileiro.',vozSintese:{vozId:'pt-BR-FranciscaNeural',pitch:1.03,rate:1.09}},
