...
const PADROES_ANTI_IA = [
  ...
  'Travessão como parêntese de narração: usar um travessão — ou par de travessões — pra encaixar uma ação, gesto ou observação de narrador NO MEIO de uma frase que não é diálogo (ex.: "Ela abriu a porta — o vento cortante entrando junto — e parou."). É marca reconhecida de texto gerado por IA. Na escrita humana, esse tipo de observação lateral normalmente vai entre parênteses, vira oração separada por vírgula, ou vira frase própria — travessão fica reservado pra diálogo (ver "Diálogo em fôrma fixa" e "Fala sem marcação" acima) ou pra um corte real e abrupto no meio da frase, não pra parênteses disfarçado.'
];
