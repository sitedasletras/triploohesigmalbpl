...
const PADROES_ANTI_IA = [
  ...
  'Vazamento de fala de assistente de IA: frases que soam como resposta de chatbot escapando pro meio da narrativa ou de um diálogo de personagem — "espero que isso ajude", "claro!", "aqui está o que você pediu", "posso continuar?", "como modelo de linguagem". Isso não pode aparecer NUNCA, nem por acidente, nem como piada de personagem — é o sinal mais grosseiro de todos, denuncia geração automática na cara.',
